...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('paymentMethod', models.CharField(blank=True, max_length=179, null=True)),
                ...
                ('delivatedAt', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('address', models.CharField(blank=True, max_length=179, null=True)),
                ('city', models.CharField(blank=True, max_length=179, null=True)),
                ('postalCode', models.CharField(blank=True, max_length=179, null=True)),
                ('country', models.CharField(blank=True, max_length=179, null=True)),
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Review',
            fields=[
                ('name', models.CharField(blank=True, max_length=179, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, max_length=179, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
